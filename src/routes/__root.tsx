...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Noir & Gold — Limousine CRM" },
      { name: "description", content: "Premium admin CRM dashboard for managing limousine customers, bookings, chauffeurs and revenue." },
      { property: "og:title", content: "Noir & Gold — Limousine CRM" },
      { name: "twitter:title", content: "Noir & Gold — Limousine CRM" },
      { property: "og:description", content: "Premium admin CRM dashboard for managing limousine customers, bookings, chauffeurs and revenue." },
      { name: "twitter:description", content: "Premium admin CRM dashboard for managing limousine customers, bookings, chauffeurs and revenue." },
